    ...
    visitor: (_visitor = {
      CallExpression: function CallExpression(path, _ref2) {
        ...
        var _opts$requireName = opts.requireName,
            requireName = _opts$requireName === undefined ? 'require' : _opts$requireName,
            map = opts.map;
      ...
      exit: function exit(path, _ref4) {
        ...
        var _opts$requireName2 = opts.requireName,
            requireName = _opts$requireName2 === undefined ? 'require' : _opts$requireName2,
            _opts$mappedRequireNa = opts.mappedRequireName,
            mappedRequireName = _opts$mappedRequireNa === undefined ? '$__require' : _opts$mappedRequireNa;
        ...
        this.parsedDependencies.forEach(function (dependency) {
